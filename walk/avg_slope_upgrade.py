...
def getSlope(walkpath_list):
    ...
    driver = webdriver.Chrome(executable_path='C:/Users/user/Desktop/4-2/capstone/code/walk/chromedriver.exe', options=option)
    ...
    for i in range(len(walkpath_list)):
        query_txt = getReGeo(walkpath_list[i][0], walkpath_list[i][1])
